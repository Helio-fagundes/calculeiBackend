package application.calculei.infraestructure.bancoCentral.ipcbr;
...
public class BcIpcbrApi implements BuscarIpcbrFromBcPort {

    private final RestTemplate restTemplate;
    private final static String BASE_URL = "https://api.bcb.gov.br/dados/serie/bcdata.sgs.191/dados?formato=json";

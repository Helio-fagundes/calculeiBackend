package application.calculei.infraestructure.bancoCentral.ipca;
...
public class BcIpcaApi implements BuscarIpcaFromBcPort {

    private final static String BASE_URL = "https://api.bcb.gov.br/dados/serie/bcdata.sgs.433/dados?formato=json";

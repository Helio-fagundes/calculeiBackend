...
@Setter
@Entity
@Table(name = "tbl_selic_diario")
public class SelicDiario extends BaseEntity {

    @JoinColumn(name = "ID_BC", referencedColumnName = "id_bc", nullable = false)
    @ManyToOne
    private IndiceBC indiceBC;

    public SelicDiario(Long id, BigDecimal fator, LocalDate dataInit, IndiceBC indiceBC) {

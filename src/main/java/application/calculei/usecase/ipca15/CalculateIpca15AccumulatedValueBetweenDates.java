...
public class CalculateIpca15AccumulatedValueBetweenDates {
    ...
    public CalculateIpca15AccumulatedValueBetweenDates(IndexRepository repository) {
        this.repository = repository;
    }

    public CalculateIpca15BetweenDateResponse execute(CalculateIpca15BetweenDateRequest request){
        ...
        if (listEntity.isEmpty()) {
            throw new DataNotFoundException("Nenhum índice IPCA-15 encontrado para o período informado.");
        }
        ...
        return new CalculateIpca15BetweenDateResponse(
                request.startDate(),
                request.endDate(),
                businessDays,
                valueFinal,

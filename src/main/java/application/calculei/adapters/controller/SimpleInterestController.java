...
public class SimpleInterestController {
    ...
    @ApiResponse(content = @Content(schema = @Schema(description = "Requisição para cálculo do Juros Simples", implementation = SimpleInterestRequestDTO.class)))
    @ApiResponse(content = @Content(schema = @Schema(description = "Resposta para cálculo do Juros Simples", implementation = SimpleInterestRequestDTO.class)))
    @ApiPostResponses
    public SimpleInterestResponseDTO execute(@RequestBody @Valid SimpleInterestRequestDTO request, @PathVariable BigDecimal interest) {
    ...
    @ApiResponse(content = @Content(schema = @Schema(description = "Requisição para cálculo do Juros Simples por período", implementation = SimpleInterestRequestDTO.class)))
    @ApiResponse(content = @Content(schema = @Schema(description = "Resposta para cálculo do Juros Simples por período", implementation = SimpleInterestRequestDTO.class)))
    @ApiPostResponses
    public SimpleInterestResponseDTO executePeriod(@RequestBody @Valid SimpleInterestRequestDTO request) {

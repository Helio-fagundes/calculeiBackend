...
class CalculateSelicDiarioAccumulatedValueBetweenDatesTest {

    @Mock
    private IndexRepository repository;

    @InjectMocks
    private CalculateSelicDiarioAccumulatedValueBetweenDates useCase;
    ...
    class SuccessScenarios {
        ...
        void givenRequestValid_whenExecute_thenReturnCalculateSelicDiarioBetweenDateResponse() {

            //GIVEN
            LocalDate startDate = LocalDate.now().minusDays(10);
            LocalDate endDate = LocalDate.now();
            Double amount = 1000.0;
            CalculateSelicDiarioBetweenDateRequest request = new CalculateSelicDiarioBetweenDateRequest(amount, startDate, endDate);
            ...
            CalculateSelicDiarioBetweenDateResponse response = useCase.execute(request);

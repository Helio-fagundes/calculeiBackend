...
class CalculateSelicMensalAccumulatedValueBetweenDatesTest {

    @Mock
    private IndexRepository repository;

    @InjectMocks
    private CalculateSelicMensalAccumulatedValueBetweenDates useCase;
    ...
    class SuccessScenarios {
        ...
        void givenRequestValid_whenExecute_thenReturnCalculateSelicMensalBetweenDateResponse() {

            //GIVEN
            LocalDate startDate = LocalDate.now().minusDays(10);
            LocalDate endDate = LocalDate.now();
            Double amount = 1000.0;
            CalculateSelicMensalBetweenDateRequest request = new CalculateSelicMensalBetweenDateRequest(amount, startDate, endDate);
            ...
            //WHEN
            when(repository.findByDataInitBetween(startDate.plusMonths(1), endDate.minusMonths(1))).thenReturn(List.of(index1, index2));
            CalculateSelicMensalBetweenDateResponse response = useCase.execute(request);
            ...
            verify(repository, times(1)).findByDataInitBetween(startDate.plusMonths(1), endDate.minusMonths(1));
        }
    }
    ...
    class ErrorScenarios {
        ...
        void givenNoIndexesForPeriod_whenExecute_thenThrowDataNotFoundException() {
            ...
            //WHEN
            when(repository.findByDataInitBetween(startDate.plusMonths(1), endDate.minusMonths(1))).thenReturn(List.of());

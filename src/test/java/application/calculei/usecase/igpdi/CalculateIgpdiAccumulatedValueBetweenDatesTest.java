...
class CalculateIgpdiAccumulatedValueBetweenDatesTest {

    @Mock
    private IndexRepository repository;

    @InjectMocks
    private CalculateIgpdiAccumulatedValueBetweenDates useCase;
    ...
    class SuccessScenarios {
        ...
        void givenRequestValid_whenExecute_thenReturnCalculateIgpdiBetweenDateResponse() {

            //GIVEN
            LocalDate startDate = LocalDate.now().minusDays(10);
            LocalDate endDate = LocalDate.now();
            Double amount = 1000.0;
            CalculateIgpdiBetweenDateRequest request = new CalculateIgpdiBetweenDateRequest(amount, startDate, endDate);
            ...
            CalculateIgpdiBetweenDateResponse response = useCase.execute(request);

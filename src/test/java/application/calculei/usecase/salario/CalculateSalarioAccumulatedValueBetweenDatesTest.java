...
class CalculateSalarioAccumulatedValueBetweenDatesTest {

    @Mock
    private IndexRepository repository;

    @InjectMocks
    private CalculateSalarioAccumulatedValueBetweenDates useCase;
    ...
    class SuccessScenarios {
        ...
        void givenRequestValid_whenExecute_thenReturnCalculateSalarioBetweenDateResponse(){

            //GIVEN
            LocalDate startDate = LocalDate.now().minusDays(10);
            LocalDate endDate = LocalDate.now();
            Double amount = 1000.0;
            CalculateSalarioBetweenDateRequest request = new CalculateSalarioBetweenDateRequest(amount, startDate, endDate);
            ...
            CalculateSalarioBetweenDateResponse response = useCase.execute(request);

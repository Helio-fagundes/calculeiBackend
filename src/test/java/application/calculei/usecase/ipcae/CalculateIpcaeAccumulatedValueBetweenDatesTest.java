...
class CalculateIpcaeAccumulatedValueBetweenDatesTest {

    @Mock
    private IndexRepository repository;

    @InjectMocks
    private CalculateIpcaeAccumulatedValueBetweenDates useCase;
    ...
    class SuccessScenarios {
        ...
        void givenRequestValid_whenExecute_thenReturnCalculateIpcaeBetweenDateResponse() {
            ...
            CalculateIpcaeBetweenDateRequest request = new CalculateIpcaeBetweenDateRequest(amount, startDate, endDate);
            ...
            CalculateIpcaeBetweenDateResponse response = useCase.execute(request);
